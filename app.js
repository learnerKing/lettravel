...
app.use(session({
  ...
  resave: false,
  //below code I copied from discussion section because chris one not working
  store: MongoStore.create({
    mongoUrl: "mongodb+srv://letstravel:letstravel123@cluster0.5nv6tsh.mongodb.net/?retryWrites=true&w=majority"
    })
}));
